  ...
  return (
    ...
    <div className={styles['popup-ticket']}>
      <div className={styles['popup-modal']}>
        <div className={styles['popup-modal__title']}>Успешно!</div>
        <div className={styles['popup-modal__subtitle']}>Сейчас вы будете перенаправлены на оплату</div>
      </div>
      ...
      <div className={styles['popup-ticket__close']}>
