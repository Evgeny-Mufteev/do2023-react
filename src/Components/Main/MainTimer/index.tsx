...
const MainTimer = () => {
  ...
  return (
    <div className={styles.timer}>
      <p className={styles['timer-title']}>До конца курса</p>
      <div className={styles.countdown}>
        <div className={styles.timer__days}>
          <span className={styles.timer__number}>{timeLeft.days}</span>
        </div>

        <div className={styles.countdown__block}>
          <div className={styles.timer__hours}>
            <span className={styles.timer__number}>{timeLeft.hours}</span>
          </div>
          <p className={styles.timer__colon}>:</p>
          <div id="minutes" className={styles.timer__minutes}>
            <span className={styles.timer__number}>{timeLeft.minutes}</span>
          </div>
          <p className={styles.timer__colon}>:</p>
          <div id="seconds" className={styles.timer__seconds}>
            <span className={styles.timer__number}>{timeLeft.seconds}</span>
          </div>
        </div>
